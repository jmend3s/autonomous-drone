...
echo "export GZ_SIM_RESOURCE_PATH=/home/$USER/$WORKDIR/src/drone_gazebo/models:/home/$USER/$WORKDIR/src/drone_description/meshes:/home/$USER/$WORKDIR/src" >> /home/$USER/.bashrc
echo "export GZ_SIM_SYSTEM_PLUGIN_PATH=/home/$USER/$WORKDIR/install/drone_gazebo_sim/lib/" >> /home/$USER/.bashrc
